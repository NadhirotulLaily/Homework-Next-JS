...
export default function BookDetails({ book }) {
  ...
  return (
    <Wrapper>
      <VStack>
        ...
        {isLoggedIn && (
          <HStack>
            <Popover>
              <PopoverTrigger>
                <Button mt="4" bg="red" color="white">Delete</Button>
              </PopoverTrigger>
              <PopoverContent>
                <PopoverArrow />
                <PopoverCloseButton />
                ...
                <Button onClick={handleDeleteBook} mt="4" bg="red" color="white">
                  Delete
                </Button>
              </PopoverContent>
            </Popover>
            <Link href={`/edit/${router.query.id}`}>
              <Button mt="4" bg="gray" color="white">Edit</Button>
            </Link>
          </HStack>
        )}
      </VStack>
      <VStack>
        <Link href="/">
          <Button mt="4" bg="#427D9D" color="white" textAlign="center">
            Back
          </Button>
        </Link>
      </VStack>
